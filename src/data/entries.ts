export default [
  {
    ...
    dates: {
      from: new Date("January 21, 2021"),
      to: new Date("January 24, 2021")
    },
  ...
  },
  {
    ...
    dates: {
      from: new Date("May 27, 2021"),
      to: new Date("June 8, 2021")
    },
    text: `The Sydney Opera House is a multi-venue performing arts centre in Sydney. Located on the banks of the Sydney
      Harbour, it is often regarded as one of the 20th century's most famous and distinctive buildings.`
  },
  {
    id: 3,
    image: {
    ...
    dates: {
      from: new Date("October 1, 2021"),
      to: new Date("November 18, 2021")
    },
    text: `The Geiranger Fjord is a fjord in the Sunnmøre region of Møre og Romsdal county, Norway. It is located
